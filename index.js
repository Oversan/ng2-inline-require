...
const file = path.join(__dirname, 'test','autocomplete-input.component.ts')
const inlineFile = path.join(__dirname, 'test','autocomplete-input.component.inline.ts')
...
let fileString = fs.readFileSync(file, {encoding: 'UTF-8'})
...
fs.writeFileSync(inlineFile, fileString)
